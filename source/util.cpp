...
static const HidsysNotificationLedPattern breathingpattern = {
    ...
    .totalFullCycles = 0x4,       // 2 full cycles.
...
{
    printf("[debug#parseStringToButton] arg: %s\t|| strcmp(command, \"DR\"): %d || strcmp(command, \"DRIGHT\"): %d\n", arg, strcmp(arg, "DR"), strcmp(arg, "DRIGHT"));
    ...
    {
        return (HidNpadButton)HiddbgNpadButton_Home;
    }
    else if (strcmp(arg, "CAPTURE") == 0)
    {
        return (HidNpadButton)HiddbgNpadButton_Capture;
    }
